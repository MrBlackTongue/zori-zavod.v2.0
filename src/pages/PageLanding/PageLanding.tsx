  ...
  return (
    <div className='container-all'>
      ...
      <div className='container-Block-2'>
        <img src="/manufacture_work.png" alt="factoryApp" className='container-jumbotron2'/>
      ...
      <div className='container-Block-123'>
      ...
      <div className='container-Block-4'>
        ...
        <div className='card-grid'>
          <Row gutter={[30, 30]} justify="center" align="top">
            ...
            <Col span={7}>
              <Card bordered={false} className='card-style-2'>
                <img alt="earth" src="/international.png" className="card-image-2"/>
      ...
      <div className='container-footer'>
        ...
        <a href="https:www.flaticon.com/ru/authors/itim2101" className='text-footer2'>
